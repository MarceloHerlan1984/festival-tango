...
let projects = [
  {
    image: "textures/itk.jpg",
    url: "https://intelektron.com",
  },
  {
    image: "textures/amb.png",
    url: "https://ambito.com.ar",
  },
...
function loadIntroText() {
  ...
  loader.load("fonts/unione.json", function (font) {
    ...
    const titleGeo = new TextGeometry("MARCELO HERLAN", {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load("fonts/helvatica.json", function (font) {
    ...
    const subTitleGeo = new TextGeometry("WEB DEVELOPER / BASED IN FINLAND", {
      font: font,
      size: 0.018,
      height: 0,
    });
